      ...
      <div className="container w-full h-full md:my-40 my-20 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
          ...
          <div id="card"
            ...
            />
            <div className="z-10">
              <p className="headtext">Hi, I'm Ankit Rathore</p>
              <p className="subtext">
          ...
          {/* Grid 2 */}
          <div id="card" className="grid-default-color grid-2">
            <div
              ref={grid2Container}
          ...
          {/* Grid 3 */}
          <div id="card" className="grid-black-color grid-3">
          ...
          {/* Grid 4 */}
          <div id="card" className="grid-special-color grid-4">
          ...
          {/* Grid 5 */}
          <div id="card" className="grid-default-color grid-5">
            <div className="z-10 w-[50%]">

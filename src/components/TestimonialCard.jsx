const TestimonialCard = ({ testimonial , id }) => {
  return (
    <div id={id} className="col-span-1 bg-black-300 testimonial-card group rounded-xl">
      <div className="group-hover:bg-blue-500 transition-all duration-700 p-10 rounded-xl">
        ...
        <div className="flex md:flex-row flex-col md:items-center justify-between md:mt-20 mt-10">
          <div>
            ...
            <p className="md:text-xl text-sm opacity-70 font-light group-hover:text-white transition-all duration-700">
              {testimonial.pos}
            </p>
          </div>
          <div className="flex items-center gap-3 md:mt-0 mt-5">
            ...
            <img src="./images/fb.svg" alt="x" className="md:size-12 size-5 group-hover:mix-blend-luminosity transition-all duration-700" />
          </div>
        </div>
      </div>
    </div>
